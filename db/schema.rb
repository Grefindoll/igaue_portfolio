...
ActiveRecord::Schema[7.0].define(version: 2025_05_16_144950) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.bigint "flower_spot_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["flower_spot_id"], name: "index_favorites_on_flower_spot_id"
    t.index ["user_id", "flower_spot_id"], name: "index_favorites_on_user_id_and_flower_spot_id", unique: true
  ...
  add_foreign_key "favorites", "flower_spots"
